...
export async function createSpecial(db, s) {
  ...
  let cols = ['id', 'advisor_id', 'cruise_line', 'ship', 'headline', 'description', 'sail_dates',
    'rate_from', 'brochure_price', 'cabin_category', 'depart_date', 'all_dates', 'itinerary', 'departure_port', 'destination', 'expires_on', 'us_canada_only', 'status', 'created_at', 'updated_at'];
  ...
  const optional = ['expires_on', 'depart_date', 'all_dates', 'itinerary', 'departure_port', 'destination', 'cabin_category'];
...
export async function updateSpecial(db, id, advisorId, s) {
  ...
  let sets = ['cruise_line', 'ship', 'headline', 'description', 'sail_dates', 'rate_from',
    'brochure_price', 'cabin_category', 'depart_date', 'all_dates', 'itinerary', 'departure_port', 'destination', 'expires_on', 'us_canada_only', 'updated_at'];
